...
public class AlarmClock extends DataSupport implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeInt(ringPager);
        dest.writeInt(volume);
        dest.writeByte((byte) (vibrate ? 1 : 0));
        dest.writeByte((byte) (nap ? 1 : 0));
        dest.writeInt(napInterval);
        dest.writeInt(napTimes);
        dest.writeByte((byte) (weaPrompt ? 1 : 0));
        dest.writeByte((byte) (onOff ? 1 : 0));
    }
