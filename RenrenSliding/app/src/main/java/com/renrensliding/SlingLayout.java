...
/**
 * Created by JOE on 2016/3/16.
 */
public class SlingLayout extends LinearLayout implements View.OnTouchListener{
    /**
     ...
     * @param attrs
     */
    public SlingLayout(Context context, AttributeSet attrs) {
        super(context);
