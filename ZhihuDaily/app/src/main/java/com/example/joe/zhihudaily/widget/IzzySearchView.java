...
public class IzzySearchView extends LinearLayout{
    ...
    private static class SearchAutoComplete extends AutoCompleteTextView{
        ...
        AutoCompleteTextViewReflector() {
            ...
            try{
                ensureImeVisible = AutoCompleteTextView.class
                        .getDeclaredMethod("ensureImeVisible", boolean.class);
            ...
            try{
                showSoftInputUnchecked = AutoCompleteTextView.class
                        .getDeclaredMethod("showSoftInputUnchecked", int.class, ResultReceiver.class);
            }catch(NoSuchMethodException e) {
